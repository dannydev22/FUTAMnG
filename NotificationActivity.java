...
public class NotificationActivity extends AppCompatActivity {
	...
	private DatabaseReference data = _firebase.getReference("FUTAMnG/UserNotifications");
	private ChildEventListener _data_child_listener;
	private DatabaseReference update = _firebase.getReference("FUTAMnG/UserUpdate");
	...
	private void initializeLogic() {
		...
		map = new HashMap<>();
		map.put("updateurl", "https://t.me/Harooncodes");
		update.child("updateURL").updateChildren(map);
		map.clear();
	}
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			if (_data.get((int)_position).get("url").toString().equals("")) {
